                    ...
                    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10 text-gray-500 text-sm">
                                <li className='my-3'>
                                    <Link href='' className="hover:text-gray-800">Features</Link>
                                </li>
                                <li className='my-3'>
                                    <Link href='' className="hover:text-gray-800">Pricing</Link>
                                </li>
                                <li className='my-3'>
                                    <Link href='' className="hover:text-gray-800">Case Studies</Link>
                                </li>
                                <li className='my-3'>
                                    <Link href='' className="hover:text-gray-800">Reviews</Link>
                                </li>
                                <li className='my-3'>
                                    <Link href='' className="hover:text-gray-800">Updates</Link>
                                </li>
                            </nav>
                        </div>
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10 text-gray-500 text-sm">
                                ...
                                <li className='my-3'>
                                    <Link href='' className="hover:text-gray-800">Culture</Link>
                                </li>
                                <li className='my-3'>
                                    <Link href='' className="hover:text-gray-800">Blog</Link>
                                </li>
                            </nav>
                        </div>
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10 text-gray-500 text-sm">
                                <li className='my-3'>
                                    <Link href='' className="hover:text-gray-800">Getting Started</Link>
                                </li>
                                <li className='my-3'>
                                    <Link href='' className="hover:text-gray-800">Help center</Link>
                                </li>
                                <li className='my-3'>
                                    <Link href='' className="hover:text-gray-800">Server status</Link>
                                </li>
                                <li className='my-3'>
                                    <Link href='' className="hover:text-gray-800">Report a bug</Link>
                                </li>
                                <li className='my-3'>
                                    <Link href='' className="hover:text-gray-800">Chat support</Link>
                                </li>
                            </nav>
                        </div>
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10 text-gray-500 text-sm">
                                <li className='my-3 flex gap-1 justify-center md:justify-start'>
                                    ...
                                    <Link  className="hover:text-gray-800" href='mailto:email@gmail.com'>email@gmail.com</Link>
                                </li>
                                <li className='my-3 flex gap-1 justify-center md:justify-start'>
                                    <Image width={20} height={100} quality={100} alt='icon' src='/phone.svg' priority />
                                    <Link  className="hover:text-gray-800" href='tel:0123456789'>(xx) xxxx-xxxx</Link>
                                </li>
                                <li className='my-3 flex gap-1 items-start justify-center md:justify-start'>
                                    ...
                                    <Link href='' className="hover:text-gray-800" >794 Mcallister St San Francisco, 94102</Link>
                                </li>
                            </nav>
                        </div>
                    </div>
            ...
            <div className="bg-muted py-4 w-full">
                <div className="container mx-auto py-4 px-5 flex flex-wrap justify-between flex-col sm:flex-row sm:text-center">
                    <p className="text-gray-500 text-sm text-center sm:text-left">Copyright © 2024
                        <Link  href="" rel="noopener noreferrer" className="ml-1 text-[#6D5FFD]" target="_blank">VacayBuddy. </Link>
                        All Rights Reserved.</p>


                    <div className="flex justify-center sm:text-center">
                        <Link  href="" rel="noopener noreferrer" className="ml-1 text-[#6D5FFD] underline" target="_blank">Terms & Conditions</Link>
                        <p className="mx-2">|</p>
                        <Link  href="" rel="noopener noreferrer" className="ml-1 text-[#6D5FFD] underline" target="_blank">Privacy Policy </Link>
                    </div>
                </div>
            </div>
