...
const ExpenseSection = ({planId}: {planId: string}) => {
  ...
  if (data && data.length == 0)
    return (
      <div
        className="flex flex-col justify-center items-center gap-3 shadow-md
                     bg-[#F5F5F5] rounded-[30px] w-full h-full font-sans"
      >
        <p className="font-semibold text-3xl">You haven't added any Expenses yet!</p>
        <p className="px-8 max-w-xl text-center text-gray-600">
