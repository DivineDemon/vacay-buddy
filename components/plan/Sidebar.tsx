...
const Sidebar = ({
  ...
  return (
    <aside className="sticky top-[8rem] min-h-[100vh]">
      <div className="space-y-2">
        <h2 className="mb-4 md:text-[30px] text-base font-semibold tracking-tight">Your Plan</h2>
      ...
      <div className="space-y-2">
        <h2 className="my-2 text-[26px] font-semibold tracking-tight">Control Center</h2>
        <div className="flex flex-col">
