...
export const ACTIVITY_PREFERENCES = [
  {id: "sightseeing", displayName: "Sightseeing", icon: Image },
  {id: "adventure", displayName: "Adventure", icon: Ship},
  ...
  {id: "shopping", displayName: "Shopping", icon: ShoppingBasket},
  {id: "nightlife", displayName: "Nightlife", icon: Moon},
];

export const COMPANION_PREFERENCES = [
  {id: "solo", displayName: "Solo", icon: User },
  {id: "couple", displayName: "Couple", icon: Heart},
  {id: "family", displayName: "Family", icon: Users},
